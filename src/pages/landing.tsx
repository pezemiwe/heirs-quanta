        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mb-8 max-w-lg text-base leading-relaxed text-dark-gray/60">
              ...
              into a single, audit-ready platform — engineered for CBN
...
const MODULES = [
  {
    ...
    subtitle: "Real-time investment portfolio analytics & risk monitoring",
    description:
      "Gain complete visibility into the Heirs Holdings investment portfolio. Monitor security performance, track stage migrations, analyse concentration risk, and generate executive-level portfolio reports — all in real time.",
    capabilities: [
      "Securities ingestion & classification",
      "Concentration & sector analysis",
      "Stage migration heatmaps",
  ...
  },
  {
    ...
    subtitle: "Fair value & financial instrument valuation",
    description:
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        >
          ...
          <p className="max-w-xl text-base leading-relaxed text-dark-gray/58">
            Each module is purpose-built for a distinct financial workflow, yet
            seamlessly integrated — data flows across modules without manual
            intervention.
          </p>
        </div>
...
/* ── Heirs Ecosystem Strip ──────────────────────────────────── */
const HeirsEcosystemSection = () => {
  const entities = [
    "Heirs Insurance",
    "United Capital",
